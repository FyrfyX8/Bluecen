		...
		BluecenMod.queueServerWork(20, () -> {
			{
				...
				entity.getCapability(BluecenModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.PortalTravelAllowed = _setval;
					capability.syncPlayerVariables(entity);
				});
			}
		});
		if ((entity.getCapability(BluecenModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new BluecenModVariables.PlayerVariables())).PortalTravelAllowed == true) {
			sx = -3;
			found = false;
