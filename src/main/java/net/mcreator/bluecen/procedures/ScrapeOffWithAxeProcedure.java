...
public class ScrapeOffWithAxeProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof AxeItem && (world.getBlockState(new BlockPos(x, y, z))).getBlock() == BluecenModBlocks.MOSSY_ENDLESS_STONE.get()) {
			{
			...
			if (world instanceof Level _level && !_level.isClientSide()) {
				ItemEntity entityToSpawn = new ItemEntity(_level, x, (y + 1), z, new ItemStack(BluecenModItems.ENDLESS_MOSS.get()));
