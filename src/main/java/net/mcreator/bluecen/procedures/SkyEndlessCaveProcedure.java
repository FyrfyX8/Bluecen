...
public class SkyEndlessCaveProcedure {
				...
				if (cloudsType == CloudStatus.FANCY) {
					for (int i = -3; i <= 4; i++) {
						for (int j = -3; j <= 4; j++) {
							...
							if (vy3 <= 5.0D) {
								bufferBuilder.vertex(vx3 + 0.0D, vy3 + 4.0D - 9.765625E-4D, vz3 + 8.0D).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed0, cloudGreen0, cloudBlue0, cloudAlpha0)
										.normal(0.0F, 1.0F, 0.0F).endVertex();
								bufferBuilder.vertex(vx3 + 8.0D, vy3 + 4.0D - 9.765625E-4D, vz3 + 8.0D).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed0, cloudGreen0, cloudBlue0, cloudAlpha0)
										.normal(0.0F, 1.0F, 0.0F).endVertex();
								bufferBuilder.vertex(vx3 + 8.0D, vy3 + 4.0D - 9.765625E-4D, vz3 + 0.0D).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed0, cloudGreen0, cloudBlue0, cloudAlpha0)
										.normal(0.0F, 1.0F, 0.0F).endVertex();
								bufferBuilder.vertex(vx3 + 0.0D, vy3 + 4.0D - 9.765625E-4D, vz3 + 0.0D).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed0, cloudGreen0, cloudBlue0, cloudAlpha0)
										.normal(0.0F, 1.0F, 0.0F).endVertex();
							}
							if (i > -1) {
								for (int k = 0; k < 8; k++) {
									bufferBuilder.vertex(vx3 + k, vy3 + 0.0D, vz3 + 8.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0).normal(-1.0F, 0.0F, 0.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + k, vy3 + 4.0D, vz3 + 8.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0).normal(-1.0F, 0.0F, 0.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + k, vy3 + 4.0D, vz3 + 0.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0).normal(-1.0F, 0.0F, 0.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + k, vy3 + 0.0D, vz3 + 0.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0).normal(-1.0F, 0.0F, 0.0F)
											.endVertex();
								}
							}
							if (i <= 1) {
								for (int k = 0; k < 8; k++) {
									bufferBuilder.vertex(vx3 + k + 1.0D - 9.765625E-4D, vy3 + 0.0D, vz3 + 8.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0)
											.normal(1.0F, 0.0F, 0.0F).endVertex();
									bufferBuilder.vertex(vx3 + k + 1.0D - 9.765625E-4D, vy3 + 4.0D, vz3 + 8.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 8.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0)
											.normal(1.0F, 0.0F, 0.0F).endVertex();
									bufferBuilder.vertex(vx3 + k + 1.0D - 9.765625E-4D, vy3 + 4.0D, vz3 + 0.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0)
											.normal(1.0F, 0.0F, 0.0F).endVertex();
									bufferBuilder.vertex(vx3 + k + 1.0D - 9.765625E-4D, vy3 + 0.0D, vz3 + 0.0D).uv(((float) vx3 + k + 0.5F) * factor + u, ((float) vz3 + 0.0F) * factor + v).color(cloudRed1, cloudGreen1, cloudBlue1, cloudAlpha0)
											.normal(1.0F, 0.0F, 0.0F).endVertex();
								}
							}
							if (j > -1) {
								for (int k = 0; k < 8; k++) {
									bufferBuilder.vertex(vx3 + 0.0D, vy3 + 4.0D, vz3 + k).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0).normal(0.0F, 0.0F, -1.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + 8.0D, vy3 + 4.0D, vz3 + k).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0).normal(0.0F, 0.0F, -1.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + 8.0D, vy3 + 0.0D, vz3 + k).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0).normal(0.0F, 0.0F, -1.0F)
											.endVertex();
									bufferBuilder.vertex(vx3 + 0.0D, vy3 + 0.0D, vz3 + k).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0).normal(0.0F, 0.0F, -1.0F)
											.endVertex();
								}
							}
							if (j <= 1) {
								for (int k = 0; k < 8; k++) {
									bufferBuilder.vertex(vx3 + 0.0D, vy3 + 4.0D, vz3 + k + 1.0D - 9.765625E-4D).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0)
											.normal(0.0F, 0.0F, 1.0F).endVertex();
									bufferBuilder.vertex(vx3 + 8.0D, vy3 + 4.0D, vz3 + k + 1.0D - 9.765625E-4D).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0)
											.normal(0.0F, 0.0F, 1.0F).endVertex();
									bufferBuilder.vertex(vx3 + 8.0D, vy3 + 0.0D, vz3 + k + 1.0D - 9.765625E-4D).uv(((float) vx3 + 8.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0)
											.normal(0.0F, 0.0F, 1.0F).endVertex();
									bufferBuilder.vertex(vx3 + 0.0D, vy3 + 0.0D, vz3 + k + 1.0D - 9.765625E-4D).uv(((float) vx3 + 0.0F) * factor + u, ((float) vz3 + k + 0.5F) * factor + v).color(cloudRed2, cloudGreen2, cloudBlue2, cloudAlpha0)
											.normal(0.0F, 0.0F, 1.0F).endVertex();
								}
							}
						}
	...
	public static void onRenderFog(ViewportEvent.RenderFog event) {
		...
		if (isRenderable()) {
			...
			execute(event, minecraft.getCameraEntity());
			eventType = NONE;
		} else {
			eventType = NONE;
			execute(event, minecraft.getCameraEntity());
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity.level.dimension()) == (ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("bluecen:endless_cave")))) {
			renderSky(Direction.DOWN, 30, 30, 30, 100, RGBA);
			renderSky(Direction.UP, 30, 30, 30, 100, RGBA);
			renderSunlight(0, 0, 0, 0, RGBA);
			renderSunlight(0, 0, 0, 0, RGBA);
		}
	}
}
