...
public class EndlessMossRootsFeature extends RandomPatchFeature {
	...
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("bluecen:endless_caves")));
