...
public class EndlessStoneWithRiftFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("bluecen:endless_stone_with_rift", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(BluecenModBlocks.ENDLESS_STONE.get().defaultBlockState()), BluecenModBlocks.ENDLESS_STONE_WITH_RIFT.get().defaultBlockState())), 6));
	...
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("bluecen:endless_cave")));
